...
ButtonColorServer::ButtonColorServer(
    ros::NodeHandle* nh_, std::string name_cc,
    std::shared_ptr<ProjectorInterfaceController>
        projector_interface_controller)
    : as_change(
          *nh_, name_cc,
          boost::bind(&ButtonColorServer::executeChangeButtonColor, this, _1),
          false),
...
// change button color
void ButtonColorServer::executeChangeButtonColor(

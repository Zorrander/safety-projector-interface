...
ReleaseRobotStaticBorderServer::ReleaseRobotStaticBorderServer(
    ros::NodeHandle *nh_, std::string name_release_robot,
    ...
    :  // Bind the callback to the action server. False is for thread spinning
      as_release_robot(
          *nh_, name_release_robot,
          boost::bind(&ReleaseRobotStaticBorderServer::executeReleaseRobot,
                      this, _1),
          false),
...
void ReleaseRobotStaticBorderServer::executeReleaseRobot(
    const ReleaseRobotStaticBorderGoalConstPtr &goal) {
...
// send feedback
void ReleaseRobotStaticBorderServer::sendFeedbackReleaseRobot(
    std::string req_id) {
...
// send result
void ReleaseRobotStaticBorderServer::sendResultReleaseRobot(
    std::string req_id) {

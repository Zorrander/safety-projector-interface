...
InstructionProjectionServer::InstructionProjectionServer(
    ros::NodeHandle *nh_, std::string name_in,
    ...
    :  // Bind the callback to the action server. False is for thread spinning
      as_instruct(*nh_, name_in,
                  boost::bind(&InstructionProjectionServer::executeInstruction,
                              this, _1),
                  false),

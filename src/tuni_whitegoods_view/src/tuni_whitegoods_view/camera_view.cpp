...
{
    img_callback = it_.subscribe("/depth_to_rgb/image_raw", 10,  &CameraView::depthSceneCallback, this);
...
void CameraView::init() {
	camera_viz_msg = cv_bridge::CvImage(std_msgs::Header(), "bgr8", depth_colormap).toImageMsg();

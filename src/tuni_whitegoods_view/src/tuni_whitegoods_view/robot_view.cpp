...
RobotView::RobotView() {
  marker_sub = nh_.subscribe("/robot_frame_element", 1,
                             &RobotView::createRvizMarker, this);
  vis_pub =
...
void RobotView::createRvizMarker(
    const tuni_whitegoods_msgs::RobotViewElement::ConstPtr &msg) {

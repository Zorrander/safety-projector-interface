...
int main(int argc, char** argv)
{
   ...
   BookOeratorStaticBorderServer srv3"execution/projector_interface/integration/actions/set_book_operator_static_border");
   ReleaseOperatorStaticBorderServer srv3"execution/projector_interface/integration/actions/set_release_operator_static_border");

...
class Projector():
    ...
    def init_zones(self):
        name = ""
        with open('/home/altair/odin/src/projector/projector_devices_master2.json') as f: #data for projectors and the kinect
    ...
    def get_rgb_button_position(self,b):
    ...
    def fillLayoutMessage(self,l_poi):
        ...
        if interface != None:
            ...
            if len(poi) > 0:
                ...
                for i in poi:
                    t = i.get_center()
                    tmp_pt = self.get_rgb_button_position(t)
    ...
    def run(self):
        while not rospy.is_shutdown():
            ...
            l_poi = InterfacePOI()
            if self.s_marker > 0 and exist > 0:

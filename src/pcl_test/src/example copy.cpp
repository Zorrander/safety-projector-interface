...
void FusionPcl::cloud_cb(const sensor_msgs::PointCloud2ConstPtr& cloud_msg_master, const sensor_msgs::PointCloud2ConstPtr& cloud_msg_sub)
{
...
int main(int argc, char** argv)
{
  ...
  ros::NodeHandle nh_;
  ros::Publisher pub;
  message_filters::Subscriber<sensor_msgs::PointCloud2> master_sub(nh_, "/kinect_master/cloud_robot_frame", 5);
  message_filters::Subscriber<sensor_msgs::PointCloud2> sub_sub(nh_, "/kinect_sub/cloud_robot_frame", 5);
